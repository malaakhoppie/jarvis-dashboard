...
# ── Session windows (EST) ─────────────────────────────────────────────────────
SESSIONS = [
    ("Asia",    (20, 0),  (3,  0),  "#a78bfa"),
    ("London",  (3,  0),  (8,  0),  "#00d4ff"),
    ("New York",(8,  0),  (12, 0),  "#00e676"),
    ("3PM",     (14, 30), (16, 0),  "#f0b429"),
]
...
def get_market_status() -> dict:
    ...
    return {"open": True, "detail": f"Closes {next_close.strftime('%a %I:%M %p ET')} · {_fmt_eta(now, next_close)}"}
